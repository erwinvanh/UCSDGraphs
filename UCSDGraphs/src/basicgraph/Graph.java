...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int i=0; i < getNumVertices() ; i++){
			...
			int degree = OutNeighbors.size() + InNeighbors.size();
	...
	public static void main (String[] args) {
		...
		GraphAdjList testList = new GraphAdjList();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", testList);
		List<Integer> result = testList.getDistance2(1);		
		System.out.println("List - TwoHop neighbors for 1 : " + result);

		GraphAdjMatrix testMatrix = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", testMatrix);
		List<Integer> resultMatrix = testMatrix.getDistance2(1);		
		System.out.println("Matrix - TwoHop neighbors for 1 : " + resultMatrix);
